...
class AppDynamicsJob(unittest.TestCase):
    ...
    def test_app_dynamics_job(self):
        driver = self.driver
        strurl="https://list1.mysteel.com/price/p-10018--010211--1.html"
        ...
        for x in lis:
            ...
            if flag:
                ...
                if yesterday==stext:
                    ...
                    cursor.executemany(
                        "INSERT INTO 外销电商_Q195爬虫数据 ([publishdate],[href],[city],[price]) VALUES (%s,%s,%s,%s)",[(spantext,href,'海盐',tdtext)])
                    conn.commit()
                    break;
        conn.close()
